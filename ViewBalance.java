...
public class ViewBalance extends javax.swing.JFrame {
 String para;
   ...
   public ViewBalance(String para){
          this.para = para;
        initComponents();
   }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("your Server ID :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{ String sq = "SELECT * FROM client WHERE ClientId="+para;
            ...
            if(rs.next()){
                ...
                String s1 = Integer.toString(cid);
                String s2 = Integer.toString(pas);
                DateFormat dateFormat = new SimpleDateFormat("yyyy-mm-dd hh:mm:ss"); 
                String s4 = dateFormat.format(da); 
                String s5 = Integer.toString(seid);
                String s6 = Double.toString(bala);
                  
                    jTextField1.setText(s1);
                    jTextField2.setText(s2);
                    jTextField4.setText(cit);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        DB_operation d = new DB_operation();
           ...
           /*    String sqlupdate = "Update client set Passw="+
                        jTextField2.getText()+"and City="+jTextField4.getText() +
                        "and Birthday="+jTextField5.getText()+ "and ServerId="+jTextField3.getText()+"and Balance="+
                        jTextField6.getText()+
                        "Where ClientId="+para ;*/
        String sqlupdate = "Update client set Passw="+jTextField2.getText()+"Where ClientId="+para ;
                PreparedStatement preparedStmt = d.getCon().prepareStatement(sqlupdate);
                preparedStmt.executeUpdate();
                JOptionPane.showMessageDialog(null,"Updated,Press View to see Changes"); 
